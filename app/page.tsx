...
export default function Home() {
  ...
  return (
    <div className="min-h-dvh flex flex-col items-center justify-center px-6 text-center relative overflow-hidden">
      {/* Background gradient — Bosphorus silhouette */}
      <div
      ...
      <div className="absolute bottom-[30%] left-0 right-0 h-[120px] opacity-20">
        <svg viewBox="0 0 480 120" fill="#F59E0B" className="w-full h-full">
      ...
      <div className="relative z-10">
        <p className="text-xs text-[#A3A3A3] tracking-[0.3em] uppercase mb-3">
          Language Quest
        </p>

        <h1
          className="text-5xl font-bold text-amber-500 mb-2 tracking-wide"
          style={{ fontFamily: "Georgia, serif" }}
        >
          ISTANBUL
        </h1>

        <p className="text-[#A3A3A3] text-sm mb-1">Turkey</p>

        <div className="w-12 h-px bg-amber-500/30 mx-auto my-6" />

        <p className="text-white text-base leading-relaxed max-w-[300px] mb-8"
           style={{ fontFamily: "Georgia, serif" }}>
        ...
        <button
          ...
          className="px-8 py-4 bg-amber-500 text-black rounded-xl text-sm font-bold uppercase tracking-widest hover:bg-amber-400 transition-colors min-h-[48px] shadow-lg shadow-amber-500/20"
        >
          Begin Your Quest
        </button>

        <p className="text-xs text-[#A3A3A3] mt-6 opacity-60">
